...
The first part will have to be changed to fit the android stuff and get an image from there. We need it give the app engine JSON info like this {"username": "Bob", "user_id": "123", "date": "some date"} and an image. 
